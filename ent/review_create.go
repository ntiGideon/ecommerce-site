...
func (rc *ReviewCreate) SetReview(s string) *ReviewCreate {
...
func (rc *ReviewCreate) SetNillableProductID(id *int) *ReviewCreate {
	if id != nil {
...
func (rc *ReviewCreate) check() error {
	...
	if _, ok := rc.mutation.Review(); !ok {
		return &ValidationError{Name: "review", err: errors.New(`ent: missing required field "Review.review"`)}
	}
	if _, ok := rc.mutation.CreatedAt(); !ok {
